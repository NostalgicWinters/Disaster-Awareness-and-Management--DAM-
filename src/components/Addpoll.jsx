    ...
    <div>
        ...
        <div className='bg-black opacity-70 m-10 p-5 rounded-2xl'>
            ...
            <label className='text-white font-dm-sans'>
                <select id='disasters' className='bg-black opacity-50 p-2 m-2 w-70 border-1 border-white mx-18' value={disastertype} onChange={(e)=>setDisasterType(e.target.value)}>
            ...
            <div className='flex flex-row justify-around'>
                <div>
                    ...
                    <input placeholder='Enter your City' className='text-white font-dm-sans p-2 mx-2 my-4 opacity-100 border-1 border-white rounded-xl flex justify-self-start w-150' value={location} onChange={(e)=>setLocation(e.target.value)} />
                ...
                <div>
                    ...
                    <label className='text-white font-dm-sans'>
                        <select id='numbers' className='bg-black opacity-50 p-2 m-2 w-70 border-1 border-white' value={rate} onChange={(e)=>setRate(e.target.value)} >
                            <option>Select...</option>
            ...
            <button className='flex justify-self-center rounded-xl px-60 bg-red-600 hover:cursor' onClick={(e)=>{navigate('/polls', {state:{location: location, disastertype:disastertype}})}}><text className='text-white font-dm-sans mx-4 my-2'>Post</text></button>
        </div>
    </div>
  )
}
